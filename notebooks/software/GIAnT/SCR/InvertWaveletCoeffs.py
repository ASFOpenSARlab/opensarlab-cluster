...
class thread_invert(mp.Process):
    '''Class for implementing parallel inversion using multiprocessing.'''
    def __init__(self,par):
        '''Gather all relevant data needed for inversions.'''
        self.G = par.G
        self.S = par.S
        self.C = par.C
...
#####Creates dictionary of temporal functions
rep = user.timedict()
...
########String representation for storing in output file
