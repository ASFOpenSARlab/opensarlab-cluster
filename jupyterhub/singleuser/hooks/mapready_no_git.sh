...
cp /etc/jupyter-hooks/scripts/pull.py /home/jovyan/.local/lib/python3.10/site-packages/nbgitpuller/pull.py
...
cp /etc/jupyter-hooks/templates/tree.html /opt/conda/lib/python3.10/site-packages/notebook/templates/tree.html
...
cp /etc/jupyter-hooks/templates/page.html /opt/conda/lib/python3.10/site-packages/notebook/templates/page.html
