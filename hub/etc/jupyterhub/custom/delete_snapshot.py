...
class DeleteSnapshot():
    ...
    def _volume_still_exists(self, pvc_name):
    ...
    def _send_email_if_expired_and_maybe_delete(self, snapshot):
        ...
        try:
            ...
            if self._volume_still_exists(pvc_name[0]):
            ...
            if days_inactive in only_email_threshold:
                ...
                email_meta = {
                    ...
                    'BODY_HTML': """<html>
                        <head></head>
                        <body>
                        <p>The <Deployment Name> account for {username} will be deactivated in {num_days_left} days due to inactivity. Any user data will be permanently deleted.</p> 
                        <p>To stop this action, please sign back into your <Deployment Name> account and start your server.</p>
                        <p>If you have any questions please don't hesitate to email the <a href="mailto:deployment_admin_email_address@somewhere.something">Deployment Name Admin</a>.<p>
                        </body>
                ...
                email_meta = {
                    ...
                    'BODY_HTML': """<html>
                        <head></head>
                        <body>
                        <p>The <Deployment Name> account for {username} has been deactivated due to {days} days of inactivity. All user data has been permanently deleted and cannot be recovered.</p>                
                        <p>If you would like to activate your account or have any questions, please don't hesitate to email the <a href="mailto:deployment_admin_email_address@somewhere.something">Deployment Name Admin</a>.<p>
                        </body>
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cluster-name", dest="cluster_name", default="")  # add a default cluster name if you wish
    parser.add_argument("--cognito-name", dest="cognito_name", default="")  # add a default cognito name if you wish
